...
| [modernisation-platform-terraform-certificate-dns-validations](https://github.com/ministryofjustice/modernisation-platform-terraform-certificate-dns-validations)                             | Module supports the creation of DNS validations for an existing ACM certificate using platform hosted zones                                                                                                            |
