...
| <a name="enable_lambda_retrieval_policy_for_account_id"></a> [lambda\_retrieval\_policy\_for\_account\_id](#lambda\_retrieval\_policy\_for\_account\_id) | If set then it will add Lambda ECR Image Retrieval Policy for the given account ID | `list(string)` | `[]` | no |
