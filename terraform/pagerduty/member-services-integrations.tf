...
resource "pagerduty_service" "octo_platform_operations_az_dso_alerts" {
  for_each = local.dso_az_alerts.channel_ids
...
resource "pagerduty_service_integration" "octo_platform_operations_az_dso_alerts" {
  for_each = pagerduty_service.octo_platform_operations_az_dso_alerts
...
resource "pagerduty_slack_connection" "octo_platform_operations_az_dso_alerts" {
  for_each = local.dso_az_alerts.channel_ids

  source_id         = pagerduty_service.octo_platform_operations_az_dso_alerts[each.key].id
  source_type       = "service_reference"
  workspace_id      = local.slack_workspace_id
  channel_id        = each.value
  notification_type = "responder"
...
resource "pagerduty_event_orchestration_service" "octo_platform_operations_az_dso_alerts" {
  for_each = pagerduty_service.octo_platform_operations_az_dso_alerts
