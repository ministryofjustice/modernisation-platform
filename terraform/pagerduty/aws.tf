...
resource "aws_secretsmanager_secret_version" "pagerduty_integration_keys" {
  ...
  secret_string = jsonencode({
    ...
    laa_edw_nonprod_alarms               = pagerduty_service_integration.laa_edw_nonprod_cloudwatch.integration_key
    laa_edw_prod_alarms                  = pagerduty_service_integration.laa_edw_prod_cloudwatch.integration_key
  })
}
