...
resource "aws_secretsmanager_secret_version" "pagerduty_integration_keys" {
  ...
  secret_string = jsonencode({
    ...
    delius_nextcloud_nonprod_alarms      = pagerduty_service_integration.delius_nextcloud_nonprod.integration_key
    delius_nextcloud_prod_alarms         = pagerduty_service_integration.delius_nextcloud_prod.integration_key
  })
}
