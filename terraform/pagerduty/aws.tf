...
resource "aws_secretsmanager_secret_version" "pagerduty_integration_keys" {
  ...
  secret_string = jsonencode({
    ...
    #  cdpt_ifs_cloudwatch                     = pagerduty_service_integration.cdpt_ifs_cloudwatch.integration_key
...
# cdpt_ifs_cloudwatch = pagerduty_event_orchestration_integration.cdpt_ifs_cloudwatch_integration.integration_key
