        ...
        },
        {
          ...
          "Condition" : {
            "ForAnyValue:StringLike" : {
              ...
              "aws:PrincipalArn" : ["arn:aws:iam::*:role/github-actions", "arn:aws:iam::*:role/github-actions-apply", "arn:aws:iam::*:role/github-actions-environments-read-only", "arn:aws:iam::*:role/github-actions-environments-dev-test", "arn:aws:iam::*:role/aws-reserved/sso.amazonaws.com/*/AWSReservedSSO_AdministratorAccess_*", "arn:aws:iam::${local.environment_management.account_ids["testing-test"]}:role/github-actions-testing"]
            }
          }
        }
      ]
