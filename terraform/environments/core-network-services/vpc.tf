...
locals {
  cidr  = "10.230.0.0/19"
  cidrs = cidrsubnets(local.cidr, 9, 9, 9, 4, 4, 4, 4, 4, 4, 4, 4, 4)
  types = ["public", "transit-gateway", "private", "data"]
  az    = ["eu-west-2a", "eu-west-2b", "eu-west-2c"]

  cidrs_chunked = chunklist(cidrsubnets(local.cidr, 9, 9, 9, 4, 4, 4, 4, 4, 4, 4, 4, 4), 3)
  zipped = zipmap(local.types, local.cidrs_chunked)
