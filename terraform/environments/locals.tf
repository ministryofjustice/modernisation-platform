...
locals {
  ...
  organisation_security_account_id = join("", [for account in data.aws_organizations_accounts.organisation_security_accounts.accounts : account.id if account.name == "organisation-security"])
