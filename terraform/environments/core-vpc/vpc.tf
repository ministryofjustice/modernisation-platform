...
module "vpc" {
  ...
  kinesis_endpoint_url = local.is-production ? local.xsiam["xsiam_prod_network_endpoint"] : ""

  kinesis_endpoint_secret_string = local.is-production ? local.xsiam["xsiam_prod_network_secret"] : ""
