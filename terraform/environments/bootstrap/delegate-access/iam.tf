...
module "instance-scheduler-access" {
  ...
  additional_trust_roles = [format("arn:aws:iam::%s:role/LambdaInstanceSchedulerPolicy", local.environment_management.account_ids["core-shared-services-production"]]
