...
module "ad_fixngo_ssm_patching" {
  source = "github.com/ministryofjustice/modernisation-platform-terraform-ssm-patching.git?ref=dave/tm-1638-patchmanager-simple-patching-option" # test branch
  providers = {
